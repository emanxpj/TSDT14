...
By examining the pictures you see the difference between the theoretical ACF and the estimated ACF for both filters. The theoretical ACF tends to zero for higher $k$ while both Blackman-Turkey's and Barlett's-estimate are non-zero for higher $k$. This i due to the fact that both Blackman-Turkey's and Barlett's-estimate have variances not tenting to zero for higher $k$. You can also see that Barlett's estimate is slightly better than Blackman-Turkey's.\\ 
