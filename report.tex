...
\begin{figure}
    ...
    \begin{center}
      \makebox[\textwidth]{\includegraphics[width=\textwidth]{TheoACF}}
...
\begin{figure}
    ...
    \begin{center}
      \includegraphics[width=\textwidth]{TheoPSD}
...
\begin{figure}
    ...
    \begin{center}
      \makebox[\textwidth]{\includegraphics[width=\textwidth]{BTheoACF}}
...
\begin{figure}
    ...
    \begin{center}
      \includegraphics[width=\textwidth]{BTheoPSD}
...
Turkey’s and Barlett’s-estimate are shown in figure5. The estimations of the signal
filtered through the near ideal filter are shown in figure6.
...
while both Blackman-Turkey’s and Barlett’s-estimate are non-zero for higher k. This i
due to the fact that both Blackman-Turkey’s and Barlett’s-estimate have variances not
tenting to zero for higher k. You can also see that Barlett’s estimate is slightly better
...
\begin{figure}
    ...
    \begin{center}
      \includegraphics[width=\textwidth]{Periodogram}
...
\begin{figure}
    ...
    \begin{center}
      \includegraphics[width=\textwidth]{Smoothed}
...
\begin{figure}
    ...
    \begin{center}
      \includegraphics[width=\textwidth]{BPeriodogram}
...
\begin{figure}
    ...
    \begin{center}
      \includegraphics[width=\textwidth]{BSmoothed}
