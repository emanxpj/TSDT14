...
\begin{figure}
  \label{fig:TheoACFsimple}
    \begin{center}
      \makebox[\textwidth]{\includegraphics[width=\textwidth]{TheoACF}}
    \caption{Theoretical ACF of $y_{simple}$}
    \end{center}
\end{figure}

\begin{figure}
  \label{fig:TheoPSDsimple}
    \begin{center}
      \includegraphics[width=\textwidth]{TheoPSD}
    \caption{Theoretical PSD of $y_{simple}$}
    \end{center}

\end{figure}

\begin{figure}
  \label{fig:TheoACFideal}
    \begin{center}
      \makebox[\textwidth]{\includegraphics[width=\textwidth]{BTheoACF}}
    \caption{Theoretical ACF of $y_{ideal}$}
    \end{center}
\end{figure}

\begin{figure}
  \label{fig:TheoPSDideal}
    \begin{center}
      \includegraphics[width=\textwidth]{BTheoPSD}
    \caption{Theoretical PSD of $y_{ideal}$}
    \end{center}

\end{figure}

PDF estimations of the signal filtered through the simple filter are 
shown in figure7 and figure8 while the estimations of the signal 
filtered through the near ideal filter are shown in figure9 and 
figure10.\\
